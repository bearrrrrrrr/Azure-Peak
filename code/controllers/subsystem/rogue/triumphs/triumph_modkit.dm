...
/obj/item/rogueweapon/estoc/triumph //Alternate variants for the Estoc series.
	...
	gaps in an opponent's plate armor. This edgeless blade is almost exclusively half-sworded \ 
	on foot, or as a lance from saigaback. Wrapped around the grip is a roll of leather, dyed in \
