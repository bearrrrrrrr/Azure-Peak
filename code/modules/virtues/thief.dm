/datum/virtue/thief/drug_runner
	name = "Dust Runner"
	desc = "I run dust for the Thieves' Guild, and an associate has left a delivery in my stash nearby for me to pick up. I can spot others in the Guild, and Matthiosites and Bathhouse workers recognize me for it. I understand the cant."
	added_traits = list(TRAIT_DUSTRUNNER)
